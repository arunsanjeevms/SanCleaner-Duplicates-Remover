...
class MainWindow:
    ...
    def _setup_gui(self):
        ...
        # Create main window
        self.root = tk.Tk()
        self.root.title("SanCleaner - Duplicate File Finder & Cleaner by Arun Sanjeev")
        ...
        footer_text = tk.Label(
            footer_frame, 
            text="Made with love by Arun Sanjeev", 
            font=("Segoe UI", 9), 
            fg="#888888", 
            bg="#f5f5f5"
        )
        ...
        github_btn.bind("<Button-1>", lambda e: webbrowser.open("https://github.com/arunsanjeevms"))
        
        insta_btn = tk.Label(
            links_frame, 
            text="Instagram: arun_sanjeev._", 
            font=("Segoe UI", 9, "underline"), 
            fg="#C13584", 
            bg="#f5f5f5",
            cursor="hand2"
        ...
        insta_btn.bind("<Button-1>", lambda e: webbrowser.open("https://instagram.com/arun_sanjeev._"))
        
        linkedin_btn = tk.Label(
            links_frame, 
            text="LinkedIn: arunsanjeev", 
            font=("Segoe UI", 9, "underline"), 
            fg="#0077B5", 
            bg="#f5f5f5",
            cursor="hand2"
        ...
        linkedin_btn.bind("<Button-1>", lambda e: webbrowser.open("https://linkedin.com/in/arunsanjeev"))
